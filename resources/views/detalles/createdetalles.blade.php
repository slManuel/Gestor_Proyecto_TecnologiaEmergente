...
@section('content')
                        ...
                        <div class="modal-body">
                            ...
                            <div class="mb-3">
                                <input type="text" name="det_descripcion" id="n-des" placeholder="Descripción" class="form-control">
                            </div>
                      <!--      <div class="mb-3" name="det_tipo">
                                <select id="n-tipo">
                                <option>Tipo</option>
                           ...
                           <label for="det_cantidad">Cantidad:</label>
                            <div class="mb-3">
                                <input name="det_cantidad" type="number" id="n-canidad">
                            </div>
                            <label for="det_preciounitario">Precio unitario:</label>
                            <div class="mb-3">
                                <input name="det_preciounitario" type="number" id="n-canidad">
                            </div>
